...
def process_and_mark_file(measurement_file):
    ...
    try:
        ...
        logger.error(f"Error processing file {measurement_file}: {e}")
...
def process_and_import(data_folder: str,
    ...
    """Processes measurement files in a specified folder with options for periodic execution and multithreading."""
    global VERBOSE
    VERBOSE = verbose
